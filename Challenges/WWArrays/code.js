...
// 4.
console.log(`{ownersToMuch.join(' and ')}'s dogs are eating too much`);
console.log(`{ownersToLittle.join(' and ')}'s dogs are eating too little`);
...
const checkEaatingOkay = (dog) =>
  dog.curFood < dog.recFood * 1.1 && dog.curFood > dog.recFood * 0.9;

console.log(dogs.every(checkEaatingOkay));

// 7.
const dogsEatOkay = dogs.filter(checkEaatingOkay);
